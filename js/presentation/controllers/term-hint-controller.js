...
const TERMS = {
  ...
  study: {
    icon: '🏠',
    name: '書斎',
    desc: 'あなたの本棚。紙の本も電子書籍もなんでも記録OK。📚未読（まだ読んでない本）、✅読了（読み終えた本）、⏸️中断（途中でやめた本）の3つで管理できます。'
  },
  store: {
    icon: '🏪',
    name: '本屋',
  ...
  dropped: {
    icon: '⏸️',
    name: '中断',
    desc: '途中で読むのをやめた本。次はどこから読むかメモを残せるので、再開しやすい。'
  },
  wishlist: {
    icon: '💭',
    name: '気になる',
    desc: '本屋にある「いつか読みたい」本。手に入れたら書斎の未読に移動します。'
  },
  timer: {
    icon: '⏱️',
    name: '読書タイマー',
